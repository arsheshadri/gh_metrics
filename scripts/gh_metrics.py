...
conn = snowflake.connector.connect(
    ...
    password='******', #TO DO, REPLACE WITH KEYPAIR OR ENV VAR
    account='SNOWDATA',
    ...
    try:
        ...
        for event in events:
            ...
            if event.payload.get("ref_type") == "branch":
                ...
                print(f"Pull Request# {pr_number} {pr_status} from branch {source_branch} to branch {target_branch} at {pr_created_at}")
